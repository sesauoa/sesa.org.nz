export const executives: TeamMember = {
  ...
  2021: [
    ...
    {
      name: "Matthew Jakeman",
      role: "Part II Representative",
      imageName: "matthew",
    },
    {
      name: "Dave Shin",
      role: "Part III Representative",
      imageName: "dave",
    },
    {
      name: "Rawiri Hohepa",
      role: "Part IV Representative",
      imageName: "rawiri",
    },
    {
      name: "Kelly Blincoe",
      role: "Postgraduate/Staff Representative",
      imageName: "kelly",
    },
    {
      name: "Beverley Sun",
  ...
  2012: [
    ...
    {
      name: "Mikhail D’Souza",
      role: "Part II Event Manager",
      imageName: "mikhail",
    },
    {
      name: "Andrew Hughson",
      role: "Part III Event Manager",
      imageName: "andrew",
    },
    {
      name: "Alice Wang",
      role: "Part IV Event Manager",
      imageName: "alice",
    },
    {
      name: "Andrew Meads",
      role: "Postgraduate Event Manager",
      imageName: "andrew",
    },
    {
      name: "Alexander Blinder",
  ...
  2007: [
    {
      name: "Meghavi Mehta (Meghavi Doshi)",
      role: "President",
      imageName: "meghavi",
    },
    {
